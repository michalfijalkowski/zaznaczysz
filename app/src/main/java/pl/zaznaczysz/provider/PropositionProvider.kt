    ...
    companion object {
        ...
        fun propositionList(where: String): List<Proposition> {
            ...
            var list: List<Proposition> =
                Gson().fromJson(json, object : TypeToken<List<Proposition>>() {}.type)
        ...
        fun updateVoteCount(id: Int, vote: Int, promotion: Int) {
            val client = OkHttpClient()

            val proposition = Proposition(id, "", "", "", vote, 0, 0, promotion)
